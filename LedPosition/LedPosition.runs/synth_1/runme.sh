...
HD_PWD='D:/RGB_LEDS/LedPosition/LedPosition.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LedPosition_BASYS3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LedPosition_BASYS3.tcl
