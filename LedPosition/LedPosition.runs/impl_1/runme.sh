...
HD_PWD='D:/RGB_LEDS/LedPosition/LedPosition.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log LedPosition_BASYS3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source LedPosition_BASYS3.tcl -notrace
