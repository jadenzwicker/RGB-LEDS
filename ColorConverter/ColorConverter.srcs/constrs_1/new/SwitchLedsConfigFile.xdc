...
## Switches
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports {ledCount[0]}]
set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports {ledCount[1]}]
set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports {ledCount[2]}]
...
set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports leftButton]
set_property -dict { PACKAGE_PIN T17   IOSTANDARD LVCMOS33 } [get_ports rightButton]
