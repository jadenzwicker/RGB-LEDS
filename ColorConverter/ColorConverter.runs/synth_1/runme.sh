...
HD_PWD='C:/Users/jaden/OneDrive/Desktop/RGB LEDS REPO/RGB-LEDS/ColorConverter/ColorConverter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ColorConverter_BASYS3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ColorConverter_BASYS3.tcl
