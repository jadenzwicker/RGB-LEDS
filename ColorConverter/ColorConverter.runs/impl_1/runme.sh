...
HD_PWD='C:/Users/jaden/OneDrive/Desktop/RGB LEDS REPO/RGB-LEDS/ColorConverter/ColorConverter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ColorConverter_BASYS3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ColorConverter_BASYS3.tcl -notrace
